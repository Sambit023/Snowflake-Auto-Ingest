...
-- MOVING DATA FROM CURATED ZONE TO CONSUMPTION ZONE TABLES

insert into TB1.CONSUMPTION_ZONE.ITEM_DIM (
        item_id,
        item_desc,
        start_date,
        end_date,
    ...
    select 
        ...
        item_class,
        item_category
    from TB1.CURATED_ZONE.CURATED_ITEM;


insert into TB1.CONSUMPTION_ZONE.CUSTOMER_DIM (
        customer_id ,
        salutation ,
        first_name ,
        last_name ,
    ...
    select 
        ...
        birth_country ,
        email_address 
  from TB1.CURATED_ZONE.CURATED_CUSTOMER;


insert into TB1.CONSUMPTION_ZONE.ORDER_FACT (
      order_date,
      customer_dim_key ,
      item_dim_key ,
      order_count,
